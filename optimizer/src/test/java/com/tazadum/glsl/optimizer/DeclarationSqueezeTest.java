...
public class DeclarationSqueezeTest extends BaseOptimizerTest {
    ...
    private static Arguments[] getPositiveCases() {
        return new Arguments[]{
                ...
                Arguments.of("struct S{float a,b;};", "struct S{float a;float b;};"),
                Arguments.of("float c;struct S{float a,b;};", "float c;struct S{float a;float b;};"),
                Arguments.of("struct S{float a,b;};struct T{float c;};", "struct S{float a;float b;};struct T{float c;};"),
                Arguments.of(
