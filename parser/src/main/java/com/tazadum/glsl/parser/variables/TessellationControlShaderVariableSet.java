 ...
 */
public class TessellationControlShaderVariableSet extends VariableSet {
    public TessellationControlShaderVariableSet(GLSLProfile profile) {
        super(profile, ShaderType.TESSELLATION_CONTROL);
