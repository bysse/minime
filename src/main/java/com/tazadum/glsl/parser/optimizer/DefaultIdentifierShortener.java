 ...
 */
public class DefaultIdentifierShortener implements IdentifierShortener {
    ...
    public DefaultIdentifierShortener() {
        output = new Output();
    }

    public void updateIdentifiers(ParserContext parserContext, Node node, OutputConfig outputConfig) {
